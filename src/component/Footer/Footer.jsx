...
const Footer = () => {
    ...
    return (
        <Grid container sx={{ color: "#FFF", backgroundColor: "background.accent3" }}>
            <Grid
                item md={2} sm={4} xs={6}
                sx={{ p: { xs: "58px 15px 50px 15px", md: "58px 0 50px 82px" } }}
            >
            ...
            <Grid item md={2} sm={4} xs={6}
                sx={{ p: { xs: "58px 15px 50px 15px", md: "58px 15px 50px 82px" } }}
            >
                <Typography variant="subtitle1">
                    Our Company
                </Typography>
            ...
            <Grid item md={6} xs={12} sx={{ p: { xs: "10px 15px 0 15px", md: "58px 30px 0 50px" } }}>
                <Typography sx={{ mb: "10px" }} variant="subtitle1">Join our mailing list</Typography>
                <Box sx={{ display: "flex" }}>
            ...
            <Grid item xs={12} sx={{ p: { xs: "58px 0 23px 0", md: "58px 0 23px 82px" }, display: "flex", justifyContent: { xs: "center", md: "space-between" } }}>
