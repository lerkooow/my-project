      ...
      <Grid container component="div">
        ...
        >
          <Grid
            ...
            sx={{
              height: "100%",
              display: { xs: "flex", md: "null" },
              flexDirection: { xs: "column", md: "null" },
              justifyContent: { xs: "space-evenly", md: "null" },
            }}
          >
            ...
            <Button
              sx={{
                ...
                "&:hover": { color: "#000", backgroundColor: "white" },
                mb: "20px",
                height: "56px",
                width: "192px",
              }}
            >
              <Link to={"/women's clothing"}>View collection</Link>
            </Button>
            <Typography sx={{ fontSize: { xs: "1rem", sm: "1.1rem", md: "1.125rem" } }}>
              ...
              Discover the latest fashion trends, enjoy comfort and express your uniqueness with our collection. Feel
              irresistible every day - choose high-quality women's clothing from us!
            </Typography>
            <Button
              sx={{
